...
chart.Scatter(base_port_1_sigma, base_port_1_mu, main = "mu-sigma of simulation using sample method")
```
...
chart.Scatter(base_port_2_sigma, base_port_2_mu, main = "mu-sigma of simulation using simplex method")
```
...
chart.Scatter(base_port_3_sigma, base_port_3_mu, main = "mu-sigma of simulation using grid method")



base_simulation <- list("sample"=as_tibble(base_port_3), "simplex"=as_tibble(base_port_2),
